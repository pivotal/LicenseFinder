  ...
  describe Gvt do
    ...
    describe "#current_packages" do
      ...
      it "returns the packages described by 'gvt list'" do
        allow(subject).to receive(:capture).with(Gvt::SHELL_COMMAND) do
        ...
        expect(first.install_path).to eq Pathname('/app/src/vendor/my-package-name')
        ...
        expect(last.install_path).to eq Pathname('/app/src/vendor/package-name-2')
