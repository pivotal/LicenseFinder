...
describe 'Erlangmk Dependencies' do
  ...
  specify 'are shown in reports' do
    ...
    expect(erlang_developer).to be_seeing_line 'gen_batch_server, 0.8.2, "Apache 2.0"'
    ...
    expect(erlang_developer).to be_seeing_line 'ra, 1.1.2, "Apache 2.0"'
    expect(erlang_developer).to be_seeing_line 'rabbit, 3.8.5, unknown'
    expect(erlang_developer).to be_seeing_line 'rabbit_common, 3.8.5, "MIT, New BSD"'
    expect(erlang_developer).to be_seeing_line 'rabbitmq_cli, 3.8.5, unknown'
    expect(erlang_developer).to be_seeing_line 'rabbitmq_codegen, 3.8.5, unknown'
    expect(erlang_developer).to be_seeing_line 'rabbitmq_management, 3.8.5, "Apache 2.0, ISC, MIT"'
    expect(erlang_developer).to be_seeing_line 'rabbitmq_management_agent, 3.8.5, unknown'
    expect(erlang_developer).to be_seeing_line 'rabbitmq_web_dispatch, 3.8.5, unknown'
